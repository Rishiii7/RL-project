...
from .multilunarlander_base import FPS
from .multilunarlander_base import MultiLunarLanderEnv as _env
...
class raw_env(AECEnv, EzPickle):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.agents = ["lander_" + str(r) for r in range(self.env.num_agents)]
